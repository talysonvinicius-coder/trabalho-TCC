...
<aside class="sidebar-pag">
    ...
    <div class="sidebar-pag-premium">
        <i class="fas fa-shield-alt" style="color:#7c4dff; font-size:1.2rem;"></i>
        <p>Gerencie o sistema com o <strong>acesso de administrador</strong></p>
        <a href="usuario.php" class="btn-premium-sidebar">Ver Usuários</a>
    </div>
